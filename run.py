...
def main():
    ...
    parser.add_argument(
        "-a", "--admin", action="store_true", default=False, help="从admin启动(默认：否)"
    )
    parser.add_argument(
        "-b",
        "--bind",
    ...
    parser.add_argument(
        "-d", "--debug", action="store_true", default=False, help="开启DEBUG模式 (默认: 关闭"
    )
    parser.add_argument(
        "-r",
        "--use-reloader",
    ...
    parser.add_argument(
        "-g", "--gunicorn", action="store_true", default=False, help="开启重加载模式 (默认: 关闭)"
    )
    parser.add_argument(
        "-p",
        "--port",
