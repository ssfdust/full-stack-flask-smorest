...
class AdminIndexView(BaseAdminIndexView):
    ...
    def index(self):
        ...
        from app.services.admin.statistics import get_main_page_info

        info, task_success, task_run, task_fail = get_main_page_info()

        form = TodoForm()

        return self.render(self._template, info=info, todoform=form,
                           task_success=task_success, task_run=task_run,
                           task_fail=task_fail)
...
class VisitStatisticView(BaseView):
    ...
    def index(self):
        ...
        API访问统计图表API
        """
        from app.services.admin import statistics as stat
...
class MailSendView(BaseView):
    ...
    def index(self):
        ...
        send_mail.delay(request.form['emailto'],
