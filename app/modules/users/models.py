...
class Group(Model, SurrogatePK):
    ...
    :param      name: str(80)                       组名称
    :param      description: str(255)               组描述
    :param      pid: int                            父组ID
    :param      roles: Role                         组默认角色
    :param      users: User                         组成员
    :param      parent: Group                       父组
    :param      children: Group                     子组
    """
...
class UserInfo(SurrogatePK, Model):
    ...
    :param          avator_id: int                  用户头像ID
    :param          uid: int                        用户ID
    :param          avator: Storages                用户头像
    :param          user: User                      关联用户
    :param          sex: int                        性别
    :param          age: int                        年龄
    :param          first_name: str(80)             姓
    :param          second_name: str(80)            名
    """
    ...
    avator = db.relationship("Storages",
