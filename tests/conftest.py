...
def flask_app_client(flask_app):
    ...
    return utils.AuthSocketIOClient(flask_app, socketio, flask_test_client=test_client)
...
@pytest.fixture(scope="session")
def guest_user(temp_db_instance_helper):
    for _ in temp_db_instance_helper(
        utils.generate_user_instance(username="guest_user")
    ):
        yield _
