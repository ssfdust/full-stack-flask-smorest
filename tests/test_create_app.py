...
from app.factory import CONFIG_MAPPGING, create_app, AVAILABLE_MODULES
from mongoengine import disconnect


def test_create_app():
    create_app(AVAILABLE_MODULES)


@pytest.mark.parametrize('flask_config_name', ['development', 'testing'])
def test_create_app_passing_config_name(flask_config_name):
    create_app(AVAILABLE_MODULES, flask_config_name)
    disconnect()
